...
public class KanjiBasicServiceImpl implements KanjiBasicService {
	...
	public KanjiBasicServiceImpl() {
		...
		kanjilist.add(new KanjiBasic(93, "牛", "Ngưu => trâu", 4, ""));
		kanjilist.add(new KanjiBasic(94, "犬", "Khuyển => con chó", 4, ""));
		...
		kanjilist.add(new KanjiBasic(103, "疋", "Sơ, Nhã, Thất  => đơn vị đo chiều dài, tấm (vải)", 5, ""));
		...
		kanjilist.add(new KanjiBasic(113, "示", "Thị; kỳ => chỉ thị; thần đất", 5, ""));
		...
		kanjilist.add(new KanjiBasic(120, "糸", "Mịch => sợi tơ nhỏ", 6, ""));
		kanjilist.add(new KanjiBasic(121, "缶", "Phẫu => đồ sành", 6, ""));
		kanjilist.add(new KanjiBasic(122, "网", "Võng  => cái lưới", 6, ""));
		kanjilist.add(new KanjiBasic(123, "羊", "Dương => con dê", 6, ""));
		kanjilist.add(new KanjiBasic(124, "羽", "Vũ => lông vũ", 6, ""));
		...
		kanjilist.add(new KanjiBasic(145, "衣", "Y => áo", 6, ""));
		kanjilist.add(new KanjiBasic(146, "襾", "Á => che đậy, úp lên", 6, ""));
		kanjilist.add(new KanjiBasic(147, "見", "Kiến  => trông thấy", 7, ""));
		...
		kanjilist.add(new KanjiBasic(163, "邑", "Ấp => vùng đất, đất phong cho quan", 7, ""));
		...
		kanjilist.add(new KanjiBasic(168, "長", "Trường => dài; lớn (trưởng)", 8, ""));
		kanjilist.add(new KanjiBasic(169, "門", "Môn => cửa hai cánh", 8, ""));
		kanjilist.add(new KanjiBasic(170, "阜", "Phụ  => đống đất, gò đất", 8, ""));
		...
		kanjilist.add(new KanjiBasic(174, "青", "Thanh => màu xanh", 8, ""));
		kanjilist.add(new KanjiBasic(175, "非", "Phi => không", 8, ""));
		kanjilist.add(new KanjiBasic(176, "面", "Diện => mặt, bề mặt", 9, ""));
		kanjilist.add(new KanjiBasic(177, "革", "Cách => da thú; thay đổi, cải cách", 9, ""));
		kanjilist.add(new KanjiBasic(178, "韋", "Vi => da đã thuộc rồi", 9, ""));
		kanjilist.add(new KanjiBasic(179, "韭", "Phỉ, cửu => rau phỉ (hẹ)", 9, ""));
		kanjilist.add(new KanjiBasic(180, "音", "Âm => âm thanh, tiếng", 9, ""));
		kanjilist.add(new KanjiBasic(181, "頁", "Hiệt  => đầu; trang giấy", 9, ""));
		kanjilist.add(new KanjiBasic(182, "風", "Phong => gió", 9, ""));
		kanjilist.add(new KanjiBasic(183, "飛", "Phi => bay", 9, ""));
		kanjilist.add(new KanjiBasic(184, "食", "Thực => ăn", 9, ""));
		kanjilist.add(new KanjiBasic(185, "首", "Thủ => đầu", 9, ""));
		kanjilist.add(new KanjiBasic(186, "香", "Hương => mùi hương, hương thơm", 9, ""));
		kanjilist.add(new KanjiBasic(187, "馬", "Mã => con ngựa", 10, ""));
		...
		kanjilist.add(new KanjiBasic(195, "魚", "Ngư => con cá", 11, ""));
		kanjilist.add(new KanjiBasic(196, "鳥", "Điểu => con chim", 11, ""));
		kanjilist.add(new KanjiBasic(197, "鹵", "Lỗ => đất mặn", 11, ""));
		kanjilist.add(new KanjiBasic(198, "鹿", "Lộc => con hươu", 11, ""));
		kanjilist.add(new KanjiBasic(199, "麥", "Mạch => lúa mạch", 11, ""));
		...
		kanjilist.add(new KanjiBasic(210, "斉", "Tề => ngang bằng, cùng nhau", 14, ""));
		kanjilist.add(new KanjiBasic(211, "歯", "Xỉ => răng", 15, ""));
		kanjilist.add(new KanjiBasic(212, "龍", "Long  => con rồng", 16, ""));
		kanjilist.add(new KanjiBasic(213, "亀", "Quy => con rùa", 16, ""));
